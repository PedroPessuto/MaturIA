...
export default function Home() {
  const members = [
    {
      name: 'Membro 1',
      linkedin: 'https://www.linkedin.com/in/membro1',
      photo: "/people/PedroPessuto.jpg",
      role: 'Desenvolvedor',
      description: 'Responsável pelo desenvolvimento da aplicação.',
    ...
    <div className="flex flex-col min-h-screen">
      <main className="flex flex-1 mt-16 bg-gray-100">
        <section className="w-full md:w-1/2 p-8 ">
          ...
          <p>
            O MaturAI é um software inovador desenvolvido para prever a idade óssea a partir de radiografias. Utilizando
